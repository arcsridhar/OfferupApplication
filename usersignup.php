                ...
                <div class="row basic_user_log_area">
                    ...
                    <div class="col-md-5 social_login">
                        <div class="contact-link">
                            <ul>
                                ...
                                <br>
                                <li><a href="login.php"> If you are an Existing User click here to Login</a></li>
                                <br>
                                <li><a href="adspost.php">If you are an Existing User click here to add Post</a></li>
                            </ul>
                    ...
                    <div class="col-md-7 signup">
                        <form method="POST" action="#" name="signup" id="signup" class="form-group">
                            ...
                            <input type="radio" name="user_type" id="user_type" value="Individual" required> Individual | <input type="radio" name="user_type" id="user_type" value="Business" required> Business or Enterprise
                            <br><input type="checkbox" id="agree" value="agreed" name="agree" />I agree to the Terms and Conditions of <a href="#">Online Buy n Sell site</a><br>
...
if(isset($_POST['sub'])){
	...
	$insertQuery = "insert into users(name,username,email,password,phone,usertype,registrationdate) values ('$fullname','$username','$useremail','$Upass','$uphone', '$Usertype','$currentDate')";
