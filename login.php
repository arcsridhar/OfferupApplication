                ...
                <div class="row basic_user_log_area">
                    ...
                    <div class="col-md-5 social_login">
                        <div class="contact-link">
                            <ul>
                                ...
                                <br>
                                <li> <a href="usersignup.php">If You are a new user, please click here to Sign Up</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-7 signup">
                        <form method="POST" action="" name="signup">
                            ...
                            <input type="submit" value="Login" name="singin" id="singin" class="btn-success btn-lg"> <a href="forgetpassword.php">Forgot Password</a>
