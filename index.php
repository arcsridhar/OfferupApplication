    ...
    <section id="content">
        <div class="container fwhite">
            <div class="row hcontent">
                <div class="col-md-6">
                    <h3>Welcome to Online Classifieds Site - the largest </h3>
                    <h3>marketplace in United States!</h3><br>
                    <p>Buy and sell everything from used cars to mobile phones and computers,<br> or search for property, jobs and more <strong>in United States - for free!</strong></p>
                    <br>
                    ...
                    <p class="iconf">
                        <a class="icon" href="#"><img src="images/deal.png">Deals on Offerup</a><strong class="bg-warning"> NEW! </strong> Great deals delivered straight to your doorstep</p>
                </div>
                <!--Changes made-->
                <div class="col-md-2">
                ...
                <div>
                  <br></br>
                  <img src="/images/Classifieds.jpg"  height="350" width="350" align="middle">
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="container fwhite">
            <div class="row">
                <div id="iconbar" class="row text-center">
                    <div class="col-md-3">
                        <a class="icon" href="catWiseItems.php?id=5"><img src="images/phone.png"><br>Electronics</a>
                        <p>Find great deals for used electronics in United States including mobile phones, computers, laptops, TVs, cameras and much more.</p>
                    </div>
                    <div class="col-md-3">
                        <a class="icon" href="catWiseItems.php?id=15"><img src="images/car.png"><br>Cars & Vehicles</a>
                        <p>Find great deals for used electronics in United States including mobile phones, computers, laptops, TVs, cameras and much more.</p>
