...
<body>
 ...
 <header id="header">
        <div class="container">
            <div class="row">
                <div class="col-md-2"><a class="navbar-brand" href="index.php">OFFERUP</a></div>
                <div class="col-md-3 pdt"><a href="allads.php"><button class="btn btn-info " type="submit">All Advertisements</button></a> </div>
...
echo $image;
	 ...
	 $insertdata = "insert into product(user_id,title,description,price,image,areaid,subareaid,categoryid,subcategoryid,adtype,itemcondition) values('$userid', '$title', '$description', '$price', '$image','$areaid', ' $subareaid', '$categoryid', '$subcategoryid', '$type', '$condition')";
